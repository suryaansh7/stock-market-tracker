...
acc_sid="AC1c60473a70fe6ae3fe0c3f06401b1223"
auth_id="f2c87afc0cfb32ccf9f7253384f54daa"

STOCK_ENDPOINT = "https://www.alphavantage.co/query"
NEWS_ENDPOINT = "https://newsapi.org/v2/everything"
news_api_key="09e6bc58c26f404b86f145314289ab5f"
import requests

stock_params={
    "function": "TIME_SERIES_DAILY",
    "symbol":STOCK_NAME,
    "apikey": "A38LTQUH0Y3SQ0ZW"
...
diffper=0.0
diffper=((diff)/float(yesterday_closing_price))*100
if(diff>5):
    news_params={
        "apiKey":news_api_key,
        "qInTitle":COMPANY_NAME
    }
    dat1=requests.get(NEWS_ENDPOINT,params=news_params
                 )
    articles=dat1.json()["articles"]
    three_articles=articles[:3]
    print(three_articles)
    formatted_articles= [f"Headline:{article['title']}.\nBrief:{article ['description']}" for article in three_articles]
    client=Client(acc_sid,auth_id)
